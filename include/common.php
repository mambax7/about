...
//$GLOBALS['xoopsTpl']->setCompatibilityMode(true);
//$GLOBALS['xoopsTpl']->assign('mod_url', $helper->url());

//$GLOBALS['xoopsTpl']->enableCaching(true);
$GLOBALS['xoopsTpl']->cache_lifetime = 3600;

// Set cache folder
//$GLOBALS['xoopsTpl']->cache_dir = '/path/to/cache';

// Assuming $helper->url() returns the URL you want to assign
$url = $helper->url();

// Assign the URL directly to the template variable
$GLOBALS['xoopsTpl']->assign('mod_url', $url);
