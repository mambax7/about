<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_ABOUT_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4>

    <p class="even">With this module you can easily add 'About Us' page to your Website. You can also add sub-pages, as well as external links. <br> <br>
    </p>
    ...
    <p class="even">This module is Open Source, and we would love your help in making it better! You can fork this module on <a href="https://github.com/XoopsModulesArchive/about" target="_blank">GitHub</a><br><br>
