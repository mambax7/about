...
/**
     ...
     */
    public static function getEditor(?Helper $helper = null, ?array $options = null): ?\XoopsFormTextArea
    {
        $descEditor = null;
     ...
     * @return \mysqli_result query result
     */
    public static function queryFAndCheck(
        \XoopsMySQLDatabase $xoopsDB, string $sql, ?int $limit = null, ?int $start = null
    ): \mysqli_result {
        $limit  ??= 0;
        $start  ??= 0;
